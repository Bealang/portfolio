...
- **Regulamin i zasady serwera** — przejrzysta prezentacja reguł gry
- **Sekcja statusu serwera** — dynamiczny podgląd dostępności serwera
- **Pełna responsywność** — każdy gracz, niezależnie od urządzenia, zobaczy stronę w idealnej formie

### Technologie

HTML, CSS, Vanilla JavaScript, animacje CSS
