...
final class Settings {
    ...
    public function __construct($connect = true) {
        ...
        // Server IP and Port
        $this->server_ip = 'JoeCraft.pl';
        $this->server_port = 50056;

        // Template Settings
        $this->logo = 'https://www.joecraft.pl/img/favicon.png';
        $this->background = 'https://www.joecraft.pl/tlo.png';
        $this->color = '#3498DB';
        $this->logo_size = '350px';
        $this->theme_changer = true;
        $this->color_schema = 'dark'; // 'dark' and 'light' color schema supported.
        $this->particles = true; // Toggle Particles (true/false)         

        
        // Menus [icon, name, url]
        // Icons are provided by fontawesome, you can find the list here
        // https://fontawesome.com/icons?d=gallery&p=2
        $this->menu = [
            ['fas fa-home', 'Strona główna', '../index.html'],
            //['fas fa-comments', 'Forums', '/forums'],
            ['fas fa-shield-alt', 'Bany', 'index.php'],
        ];

        // Footer Block 2
        $this->block[2]['title'] = 'O nas';
        $this->block[2]['content'] = 'JoeCraft to serwer minecraft który już od 4 lat daje rozrywke i miły spędzony czas graczom!';
        
        // Footer Block 3
        $this->block[3]['title'] = 'Linki';
        // [name, url]
        $this->block[3]['content'] = [
            ['Sklep', 'https://vishop.pl/shop/8045/server/7742'],
        ...
        $this->lang = 'pl_PL.utf8';

        // Database information
        $this->host = 'node-pl-02k.icehost.pl';
        $this->port = 5891;

        $this->database = 's20361_litebans';

        $this->username = 'u20361_RuhI5wDaGn';
        $this->password = 'zuwf7IZnE^Ts7z.L8ddT!xlp';
