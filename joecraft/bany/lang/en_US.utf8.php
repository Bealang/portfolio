...
class DefaultLang {
    public function __construct() {
        $array = array();
        $this->array = &$array;
        $array["index.welcome.main"] = "Welcome to {server}'s Punishment List.";
        $array["index.welcome.sub"] = "If you believe you were punished unfairly or would like another chance please appeal on the forum.";
