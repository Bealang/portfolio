...
// Skrypty poza formularzem

function setslide(slide_nr) {
    $('.aboutus__content').removeClass('visible');
    var selectedSlide = $('.aboutus__content__' + slide_nr);
    selectedSlide.addClass('visible');
    var slideButtons = document.getElementsByClassName('aboutus__slide');
